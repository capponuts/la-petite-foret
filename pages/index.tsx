  ...
  return (
    ...
    <div>
      <Head>
        ...
        <link rel="canonical" href="https://la-petite-foret.fr/" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://la-petite-foret.fr/" />
        ...
        <meta property="og:image" content="https://la-petite-foret.fr/cover-la-petiteforet.png" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://la-petite-foret.fr/" />
        ...
        <meta property="twitter:image" content="https://la-petite-foret.fr/cover-la-petiteforet.png" />
          ...
          dangerouslySetInnerHTML={{ __html: `
            {
              ...
              "image": "https://la-petite-foret.fr/cover-la-petiteforet.png",
              "url": "https://la-petite-foret.fr/",
              "aggregateRating": {
